			...
			<div className={style.login}>
				...
				<form onSubmit={handleSubmit(onSubmit)} className={style.login__form}>
					...
					<div className={style.login__form__input}>
						...
						/>
						<span
							className='text-xs text-gray-500 ml-3.5 mt-1 hover:text-black cursor-pointer'
							onClick={() => go('/auth/password/reset')}
						>
							Forgot you password?
						</span>
					</div>
					<span className={style.login__form__warning}>
				...
				<div className='mt-4 flex items-center'>
					<Footer>
						<span
							className='text-xs text-gray-500 hover:text-black cursor-pointer flex items-center text-center'
							onClick={() => go('/auth/registration')}
						>

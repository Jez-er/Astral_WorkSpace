		...
		<div className={style.main}>
				...
				<div className={style.registration}>
					...
					>
						<div className={style.registration__form__input}>
							<span className='text-red text-xs ml-4'>
						...
						<span className={style.registration__form__warning}>
							By continuing, you agree to Astral’s Terms of Service <br /> and
					...
					<div className='mt-4 flex items-center'>
						<Footer>
							<span className='text-xs text-gray-500'>
								<div className='flex w-6 h-6 rounded-2xl border-2 border-gray-500 justify-center items-center font-medium'>
									1
								</div>
							</span>
						</Footer>
			...
			{page === 2 ? (
				<div className={style.registration2}>
					...
					<h1 className={style.registration2__title}>
						Astral <br /> <span className='font-bold text-2xl'>WorkSpace</span>
					</h1>
					<form
						onSubmit={handleSubmit(onSubmit)}
						className={style.registration2__form}
					>
						...
						<span className={style.registration2__form__warning}>
							By continuing, you agree to Astral’s Terms of Service <br /> and
							acknowledge you've read our Privacy Policy.
						</span>
